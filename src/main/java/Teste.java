...
public class Teste {
	...
	public static void main(String[] args) {
		List<String> listaDeParticipantesDaDiretoria = new ArrayList<>();
		listaDeParticipantesDaDiretoria.add(ale);
		listaDeParticipantesDaDiretoria.add(kon);
		List<String> listaDeParticipantesDaGalera = new ArrayList<>();
		listaDeParticipantesDaGalera.add(ale);
		listaDeParticipantesDaGalera.add(kon);
		listaDeParticipantesDaDiretoria.add(jose);
		listaDeParticipantesDaGalera.add(joao);
		listaDeParticipantesDaGalera.add(maria);
		listaDeParticipantesDaGalera.add(ana);
		List<String> listaDeParticipantesDaGalera2 = new ArrayList<>();
		listaDeParticipantesDaGalera2.add(ale);
		listaDeParticipantesDaGalera2.add(kon);
		listaDeParticipantesDaGalera2.add(maria);
	...
	public static void case1() { //Teste de disponibilidade  --- Horas quebradas (-0.5)
	...
	public static void case2() { //testAdicionaDisponibilidadeComComecoAntesDoInicio  (-0.0)
	...
	public static void case3() { //testAdicionaDisponibilidadeComFimAntesDoComeco (-0.5)
	...
	public static void case4(){ //testAdicionaDisponibilidadeDeParticipanteQueNaoExiste (-0.0)
	...
	public static void case5(){ //testAdicionaDisponibilidadeDepoisDoFim (-0.0)
	...
	public static void case6(){ //testSobreposicaoComplexa (-0.0)
	...
	public static void case7() { // testSobreposiçãoVazia (-0.0)
