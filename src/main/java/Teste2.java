...
public class Teste2 {
    ...
    public static GerenciadorDeSalas gerenciador = GerenciadorDeSalas.instanceOfSalasManager();
	...
	public static void main(String[] args) {
        ...
        b3.setCapacidadeMax(capacidadeDaB3);
        auditorio.setNome(nomeDoAuditorio);
        auditorio.setLocal(localDoAuditorio);
        auditorio.setCapacidadeMax(capacidadeDoAuditorio);
		...
		case3();
		case4();
        gerenciador = GerenciadorDeSalas.instanceOfSalasManager();
		case5();
		case6();
		case7();
        case8();
	...
	public static void case7() { // testaCancelaReservaQueNaoExiste
		...
		try {
            ...
            gerenciador.imprimeReservaDaSala(nomeDoAuditorio);
    ...
    public static void case9(){ //testReservaClass
        ...
        try{
            Reserva reserva = gerenciador.reservaSalaChamada(nomeDoAuditorio,LocalDateTime.of(2021, 8, 16, 10, 0, 0), LocalDateTime.of(2021, 8, 16, 12, 0, 0));
            String temp = reserva.getNomeDaSala();
            LocalDateTime ini = reserva.getDataInicial();
            LocalDateTime fim = reserva.getDataFinal();
            System.out.println(temp +": " +  dateTimeFormat.format(ini) + " - "+dateTimeFormat.format(fim));
        }
        catch(Throwable e){
            e.printStackTrace();
        }
